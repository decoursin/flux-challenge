...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__5302__auto__,k__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
return cljs.core._lookup.call(null,this__5302__auto____$1,k__5303__auto__,null);
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5304__auto__,k11393,else__5305__auto__){
var self__ = this;
var this__5304__auto____$1 = this;
var G__11395 = (((k11393 instanceof cljs.core.Keyword))?k11393.fqn:null);
switch (G__11395) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11393,else__5305__auto__);
...
var or__4688__auto____$1 = self__.post.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x));
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__5316__auto__,writer__5317__auto__,opts__5318__auto__){
var self__ = this;
...
;
return cljs.core.pr_sequential_writer.call(null,writer__5317__auto__,pr_pair__5319__auto__,"#schema.spec.variant.VariantSpec{",", ","}",opts__5318__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"pre","pre",2118456869),self__.pre],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"options","options",99638489),self__.options],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"err-f","err-f",651620941),self__.err_f],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"post","post",269697687),self__.post],null))], null),self__.__extmap));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$ = true;

schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11392){
var self__ = this;
var G__11392__$1 = this;
return (new cljs.core.RecordIter((0),G__11392__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], null),cljs.core._iterator.call(null,self__.__extmap)));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__5300__auto__){
var self__ = this;
var this__5300__auto____$1 = this;
return self__.__meta;
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__5296__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__5306__auto__){
var self__ = this;
var this__5306__auto____$1 = this;
return (4 + cljs.core.count.call(null,self__.__extmap));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__5297__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__5298__auto__,other__5299__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__5311__auto__,k__5312__auto__){
var self__ = this;
var this__5311__auto____$1 = this;
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"err-f","err-f",651620941),null,new cljs.core.Keyword(null,"post","post",269697687),null,new cljs.core.Keyword(null,"options","options",99638489),null], null), null),k__5312__auto__)){
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__5312__auto__)),null));
}
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5309__auto__,k__5310__auto__,G__11392){
var self__ = this;
var this__5309__auto____$1 = this;
var pred__11396 = cljs.core.keyword_identical_QMARK_;
var expr__11397 = k__5310__auto__;
if(cljs.core.truth_(pred__11396.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__11397))){
return (new schema.spec.variant.VariantSpec(G__11392,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11396.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__11397))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__11392,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11396.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__11397))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__11392,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11396.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__11397))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__11392,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5310__auto__,G__11392),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__5314__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5301__auto__,G__11392){
var self__ = this;
var this__5301__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__11392,self__.__extmap,self__.__hash));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__5307__auto__,entry__5308__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.cljs$lang$ctorPrSeq = (function (this__5336__auto__){
return cljs.core._conj.call(null,cljs.core.List.EMPTY,"schema.spec.variant/VariantSpec");
});

schema.spec.variant.VariantSpec.cljs$lang$ctorPrWriter = (function (this__5336__auto__,writer__5337__auto__){
return cljs.core._write.call(null,writer__5337__auto__,"schema.spec.variant/VariantSpec");
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__11394){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__11394),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__11394),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__11394),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__11394),null,cljs.core.dissoc.call(null,G__11394,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)),null));
});
...
var args11400 = [];
var len__5746__auto___11403 = arguments.length;
var i__5747__auto___11404 = (0);
while(true){
if((i__5747__auto___11404 < len__5746__auto___11403)){
args11400.push((arguments[i__5747__auto___11404]));

var G__11405 = (i__5747__auto___11404 + (1));
i__5747__auto___11404 = G__11405;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args11400.length)].join('')));
...
if(cljs.core.truth_((function (){var or__4688__auto__ = err_f;
if(cljs.core.truth_(or__4688__auto__)){
return or__4688__auto__;
} else {
...
//# sourceMappingURL=variant.js.map?rel=1496645227161